...
class Test_Organism(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_sim = Simulation("./voxcraft-sim/voxcraft-sim", "./voxcraft-sim/vx3_node_worker", "./generations", heap_size=0.6, sim_time=0.25)
        self.test_evo = Evolution(self.test_sim, 1, 1, 1, 1, 1)
        self.test_orgs = self.test_evo.construct_organisms(0)

    def test_Organism_Method_01(self):
