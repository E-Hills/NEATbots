...
class Evolution:
    ...
    def __init__(self, sim: Simulation, gen_n: int, pop_s: int, W: int, H: int, D: int):
        ...
        Args:
            sim (Simulation): The simulation object to use when simulating organisms.
    ...
    def evaluate_organisms(self, organisms: Dict[str, Organism], generation_dir: str, label: str, step_size: int):
